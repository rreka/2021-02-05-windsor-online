...
<div><pre><code><span class="kw">install.packages</span>(<span class="kw">c</span>(<span class="st">"tidyverse"</span>, <span class="st">"hexbin"</span>, <span class="st">"patchwork"</span>, <span class="st">"RSQLite"</span>))</code></pre></div>
